...
Config.DeathTime = 10                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.ReviveInterval = 10                                  -- How long the timer is for players to revive a player in laststand
Config.MinimumRevive = 10                                  -- How long the timer is for players to revive a player in laststand
